	...
	<div id="content">
		...
		<div class="row">
			<div class="col-xs col-sm-12 col-md-12 col-lg-12 col-xl-12">
				<h4>Marvel via textarea</h4>
				<nav class="breadcrumb">
					<a class="breadcrumb-item" href="#">Research components</a>
					<span class="breadcrumb-item active">Marvel via textarea</span>
				</nav> <!-- /breadcrumb -->
			</div> <!-- /col -->
		</div> <!-- /row -->
		...
		<div class="col-xs col-sm-12 col-md-12 col-lg-6 col-xl-6 mt-4">        
			<div class="card">
				...
				<div class="card-body">
					...
					<textarea class="textarea" name="textarea" id="textarea" cols="100%" rows="8" title="MARVEL input"></textarea></br></br>
...
<!-- ////////// Run Marvel ////////// -->
	...
	<script type="text/javascript" src="../js/marvel/graph.js"></script>	
	 ...
	 <script>
		...
		document.getElementById("area").className = "collapse active";
		$("#results").hide();
		...
		function RunMARVEL()
		{
			...
			var output = '<h3>Content of your file:</h3><table id="basic_table2" class="table_top_content table table-bordered table-responsive table-striped"><thead>'+
						'<tr><th>Wavenumber</th><th>Uncertanity</th><th>Quantum numbers (upstage)</th><th>Quantum numbers (downstage)</th><th>Tag</th></thead><tbody>';
			...
			if(nblines > 1000) {
				...
				// detect bad lines
				var badlines = '<h3>Badlines:</h3><table id="basic_table2" class="table_top_content table table-bordered table-responsive table-striped"><thead><tr><th>Line tag</th><th>Orig. unc. / cm-1 </th><th>Optimal unc. / cm-1</th></thead><tbody>';
				var diff = 0.0;
				var hasbad = false;
				...
				if(!hasbad) {
					$( "#message" ).prepend( '<div class="alert alert-success fade show mt-3" role="alert"><div class="alert-icon"><i class="fa fa-check" aria-hidden="true"></i></div>'+
								  ...
								  '<strong>Well done!</strong> </br>Database is self-consistent. It does not contain any bad line! </div></div>' );
				} else {
